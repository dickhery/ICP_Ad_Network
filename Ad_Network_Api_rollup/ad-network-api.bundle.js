var AdNetworkAPI = (function (exports) {
	'use strict';
	...
	const canisterId = "qanay-uyaaa-aaaag-qbbwa-cai";
	...
	async function initActorUnauthenticated() {
	  if (!adNetworkActor) {
	    ...
	    adNetworkActor = Actor.createActor(idlFactory, {
	      agent,
	      canisterId: canisterId,
	    });
	  }
	...
	exports.initActorUnauthenticated = initActorUnauthenticated;
	exports.recordViewWithToken = recordViewWithToken;
